...
const web3 = new Web3('https://rinkeby.infura.io/v3/YOUR_API_KEY') // put infura api key here
const account = 'YOUR_ACCOUNT' // testnet account address here
web3.eth.accounts.wallet.add('YOUR_PRIVATE_KEY') // private key for testnet address
